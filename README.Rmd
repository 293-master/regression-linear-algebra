...
1. You will compute least-squares fitted beta-hat values using linear regression.
...
1. You will submit your work not via GitHub pull request, but rather as you have for all other problem sets.
